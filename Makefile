...
$(eval $(call build-package,glibc,2.37-r0))
...
$(eval $(call build-package,nodejs-18,18.14.1-r0))
$(eval $(call build-package,nodejs-19,19.6.1-r0))
...
$(eval $(call build-package,jenkins,2.391-r0))
...
$(eval $(call build-package,flux,0.40.0-r0))
...
$(eval $(call spring-boot,3.0.2-r0))
